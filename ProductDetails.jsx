  ...
  return (
    <div className="product-details-page">
      ...
      <div className="product-details-info">
        ...
        <p>
          {" "}
          <b>Rating</b>: {product.reviews?.rating}
        </p>
        <p>
          {" "}
          <b>Comment </b>: {product.reviews?.comment}
        </p>
        <p>
          {" "}
          <b>Date </b>: {product.reviews?.date}
        </p>
        <p>
          {" "}
          <b>Reviewer Name </b>: {product.reviews?.reviewerName}
        </p>
        <p>
          {" "}
          <b>Reviewer Email </b>: {product.reviews?.reviewerEmail}
        </p> */}
